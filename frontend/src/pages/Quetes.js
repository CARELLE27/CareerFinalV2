  ...
  return (
    <div className="quetes-root">
            ...
            {filtrees.map(uq => {
              ...
              return (
                ...
                >
                  ...
                  {/* ✅ BOUTON LINKEDIN DIRECTEMENT SUR LA CARTE VALIDÉE */}
                  ...
                  {/* Compétences pour les non-validées */}
                  {uq.statut !== 'valide' && uq.quete.competences_debloquees?.length > 0 && (
            ...
            <div className="quete-detail-inner">
              ...
              {selected.statut === 'valide' && (
                <div className="valide-box">
                  ...
                  {selected.quete.competences_debloquees?.length > 0 && (
                    <LinkedInBtn quete={selected.quete} />
                  )}
                </div>
              )}
            </div>
      ...
      <style>{`
        ...
        .linkedin-card-btn:hover { background: #005885; transform: translateY(-1px); }
        ...
        @media (max-width: 800px) { .quetes-root { height: auto; overflow: visible; } .quetes-body { grid-template-columns: 1fr; overflow: visible; } .quetes-liste-inner { overflow-y: visible; } .quetes-col-right { overflow-y: visible; } }
      `}</style>
    </div>
  );
}